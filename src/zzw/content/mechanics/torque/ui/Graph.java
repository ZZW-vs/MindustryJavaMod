...
/**
 * 折线图 UI 组件 (PU132 unity.ui.Graph 移植)
 * <p>
 * 显示函数曲线, 支持鼠标悬停查看数值。用于调试/展示图网络数据。
 */
public class Graph extends Element{
    ...
    public void draw(){
        ...
        float sy = y + 0.06f * height, ey = y + height * 0.94f;
        float selx = x + stepw * lastMouseStep, sely = Mathf.map(fun.get(lastMouseStep), minf, maxf, sy, ey);
