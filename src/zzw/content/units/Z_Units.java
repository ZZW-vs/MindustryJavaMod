...
import zzw.content.units.type.AnomalyUnitType;
...
public class Z_Units {
    ...
    public static UnitType
        ...
        anomaly = new AnomalyUnitType("anomaly"),                   // T7 Flying (牵引光束+充能激光+6翼装饰)
    ...
    public static void load() {
        ...
        terra = new WorldUnitType("terra") {{
            ...
            // ★ 平台碰撞箱: 覆盖 8x18 子世界平台 (hitbox() 重写为随单位旋转的长方形,
            //   8x18 tile = 64x144 像素, hitSize 取长边)
            hitSize = 144f;
