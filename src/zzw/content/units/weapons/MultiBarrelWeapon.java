...
/**
 * 多枪管武器 (PU_V8 MultiBarrelWeapon 移植版)
 * - 多个枪管, 每次射击轮流使用
 * - 每个枪管独立后坐力动画
 * - 自定义绘制: 每个枪管单独绘制
 * 简化: 移除 mirrorBarrels 逻辑 (用 Mathf.sign 处理)
 * 参考: PU_V8 main/src/unity/type/weapons/MultiBarrelWeapon.java
 */
