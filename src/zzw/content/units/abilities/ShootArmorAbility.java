...
import zzw.content.type.*;

/**
 * ShootArmorAbility (PU132 unity.entities.abilities.ShootArmorAbility 完整移植)
 *
 * 功能: 单位射击时激活护甲, 增加防御力但降低移动速度
 * - 射击时 shootHeat 从 0 lerp 到 1
 * - armor 增加 armorInc * shootHeat
 * - 移动速度降低 speedReduction * shootHeat
 * - 镜像武器向外偏移 spread * shootHeat
 * - 绘制护甲贴图 (armorRegion), 透明度随 shootHeat 变化
 *
 * 依赖: UnityUnitType.weaponXs (存储武器初始 x 坐标)
 */
